...
<html lang="en">
  ...
  <body>
          ...
          <div class="container  ">
			...
			-->
                  ...
                  <ul class="pull-right nav navbar-nav navbar-right">
                      <li><a href="../u1/logout.php"> Admin Logout</a></li>
                  </ul>
              </div>
          </div>
      </nav>
      <div class="container">
          ...
          <div class="row">
              <div class="col-md-6">
                  <h2><a href="u2_Please.php"> Set Office Hours  </a> </h2>
...
-->
             <div class="col-md-6 ">
                  <h2><a href="u2_view_post.php">View, Update and Cancel Office Hours </a></h2>

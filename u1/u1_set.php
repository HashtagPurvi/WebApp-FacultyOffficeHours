...
<body>
<h1><a href="u1_Main_Login.php">Back to Admin Home Page</a></h1>
<form method="post" action="u1_set.php" enctype="multipart/form-data">
...
//			echo "Entering data in db<br/>";
			$insert_query = "INSERT INTO `please` (Name, Title, Location, Semester,Year, Mon, Tue, Wed, Thu, Fri) 
			...
			{		
				echo "<h1>Your Office Hours have been Updated</h1>";
				echo "<script>window.open('u1_Main_login.php','_self')</script>";
			}
			else{

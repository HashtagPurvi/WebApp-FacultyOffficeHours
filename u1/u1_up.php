...
<body>
<h1><a href="u1_view_post.php">Back to View Office Hours </a></h1>
...
<?php
	...
	if(isset($_GET['edit'])){
		...
		$edit_id = $_GET['edit'];
		$edit_query = "select * from please where Id= '$edit_id'";
...
<form method="post" action="u1_up.php?edit_form=<?php echo $edit_id; ?>"enctype="multipart/form-data">
...
//		var_dump($_POST['Days']);
		...
		if($post_name=='' or $post_title1=='' or $post_location1 =='' or $post_semester1==''or $post_year1=='')
		{
			...
			$update_query = "update please set Name='$post_name', Title='$post_title1', Location='$post_location1', Semester='$post_semester1', year='$post_year1', Mon='$var1', Tue='$var2', Wed='$var3', Thu='$var4', Fri='$var5' where Id='$edit_id'";
